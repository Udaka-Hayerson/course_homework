...
public class TXTHandler<writer> extends AbstractHandler {

    FileWriter writer;
    String text;

    public TXTHandler() throws Exception {
        this.writer = null;
        this.text = "";
    }
    ...
    @Override
    void open(){
        try(FileReader f_reader = new FileReader("dist/document.txt"))
        {
            // читаем посимвольно
            int c;
    ...
    void create() throws Exception {
        ...
        {
            this.writer = new FileWriter("dist/document.txt", false);
